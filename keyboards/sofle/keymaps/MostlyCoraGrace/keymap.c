...
[_QL] = LAYOUT(
  ...
  KC_CAPS,   KC_P1,   KC_P2,   KC_P3, KC_PENT, XXXXXXX, _______,       _______, XXXXXXX, XXXXXXX, KC_BSLS, S(KC_COMM),  S(KC_DOT), KC_CAPS,
 ...
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * | Tab  |      |      |      |      |      |                    | PAUSE| HOME |  Up  |  END | PGUP | F12  |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * | DEL  |      |      |      |      |      |-------.    ,-------| PRTSC| Left | Down | Right| PGDN | INS  |
 * |------+------+------+------+------+------|       |    | MUTE  |------+------+------+------+------+------|
 * | CAPS |      |      |      |      |      |-------|    |-------| SCRLK|      |      |      |      | CAPS |
 * `-----------------------------------------/       /     \      \-----------------------------------------'
...
[_QR] = LAYOUT(
  ...
  _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                         KC_PAUS, KC_HOME,   KC_UP,  KC_END, KC_PGUP,  KC_F12,
  _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                         KC_PSCR, KC_LEFT, KC_DOWN, KC_RGHT, KC_PGDN,  KC_INS,
  KC_CAPS, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______,       _______, KC_SCRL, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_CAPS,
 ...
 */
[_GA] = LAYOUT(
   KC_ESC,    KC_5,    KC_6,    KC_G,    KC_M,    KC_P,                         XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
   KC_TAB,    KC_T,    KC_Q,    KC_W,    KC_E,    KC_R,                         XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
  MO(_GL), KC_LSFT,    KC_A,    KC_S,    KC_D,    KC_F,                         XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
     KC_Z, KC_LCTL,    KC_1,    KC_2,    KC_3,    KC_4, _______,       XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
